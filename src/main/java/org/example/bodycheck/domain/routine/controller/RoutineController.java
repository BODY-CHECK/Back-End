...
public class RoutineController {
	...
	public ApiResponse<List<RoutineResponseDto.WeekRoutineDto>> getRoutineList(@PathVariable("weekId") Integer weekId,
	...
	@PostMapping("/check")
	public ApiResponse<RoutineResponseDto.RoutineIdDto> updateRoutineCheck(@AuthUser Member member,
		@RequestBody RoutineRequestDto.RoutineIdDto request) {
