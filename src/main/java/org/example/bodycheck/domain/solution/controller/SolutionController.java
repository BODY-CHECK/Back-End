...
public class SolutionController {
	...
	@Operation(summary = "솔루션 저장 API",
		description = "사용자가 솔루션을 저장하는 API 입니다. application/json이 아닌 multipart/form-data 형태입니다.")
	@Parameters({
	...
	@GetMapping("")
	@Operation(summary = "솔루션 목록 조회 API",
		description = "사용자의 솔루션 목록을 조회하는 API이며, 페이징을 포함합니다. query String으로 page 번호를 주세요.")
	@Parameters({
		@Parameter(name = "targetBody",
			description = "카테고리로, 운동 부위, query parameter 입니다! NULL, UPPER_BODY, LOWER_BODY 이렇게 셋 중 하나의 값만 입력해주세요."),
