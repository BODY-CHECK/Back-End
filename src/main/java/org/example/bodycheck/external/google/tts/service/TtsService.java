...
import org.example.bodycheck.external.google.tts.dto.TtsDto;
import org.example.bodycheck.external.google.tts.dto.TtsResultDto;
import org.example.bodycheck.external.google.tts.dto.TtsTempDto;
	...
	public GetDto getContent(Long exerciseId, Integer ttsIdx, Member member) {
		Tts tts = ttsRepository.findByExercise_IdAndTtsIdx(exerciseId, ttsIdx)
			.orElseThrow(() -> new NoSuchElementException(
				"No TTS found for exercise ID: " + exerciseId + " and TTS index: " + ttsIdx));
