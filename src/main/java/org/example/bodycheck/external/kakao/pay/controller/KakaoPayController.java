...
public class KakaoPayController {
	...
	public ApiResponse<String> approvePayment(@AuthUser Member member,
		@RequestBody KakaoPayDto.KakaoApproveRequest request) {
	...
	public ApiResponse<KakaoPayDto.KakaoSubscribeCancelResponse> subscribeCancelRequest(@AuthUser Member member) {
		KakaoPayDto.KakaoSubscribeCancelResponse kakaoSubscribeCancelResponse = kakaoPayService.subscribeKakaoPayCancel(
			member.getId());
